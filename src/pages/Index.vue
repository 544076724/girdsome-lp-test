<template>
  <Layout>
    ...
    <div data-v-460714ac="">
      <div data-v-460714ac="" class="latest-journals-heading container"><span data-v-460714ac="" class="label">
      ...
      <div data-v-460714ac="" class="latest-journals">
        <div data-v-460714ac="" class="container">
          <g-link v-for="topPost in $page.noTopPosts.edges" :key="topPost.node.id" :to="topPost.node.path" data-v-460714ac="" class="journal">
